...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="index.php" class="navbar-brand font-weight-bold text-white text-center">SOME BANK</a>
...
?> 
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:60px;height:380px;">
                   <div class="card-body">
                   <img src="images/6.jfif" style="width:250px;height:220px;margin-top:40px;">
...
if(isset($_POST['submit']))
{
    ...
    if($arrdata['Amount'] >= $Sender)
    {
      ...
      // $res_receiver=mysqli_query($con,$query_receiver);
       ...
       if($res && $rec_res)
      {
        $t_query="INSERT INTO transactions(Sender,Receiver,Amount,Status) 
        VALUES ('$Sender_name', '$Receiver_name', '$Sender','Success')";
        $result= mysqli_query($con,$t_query);
       ?>
       <script>
 ...
 {
    $y_query="INSERT INTO transactions(Sender,Receiver,Amount,Status) 
    VALUES ('$Sender_name', '$Receiver_name', '$Sender','Failed')";
    $result= mysqli_query($con,$y_query);
  ?>
    <script>
